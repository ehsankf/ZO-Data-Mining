...
def ZOSVRG(delImgAT_Init, MGR, objfunc):
    ...
    for S_idx in range(1, MGR.parSet['nStage']+1):
        ...
        #print("\n")
        flag = True 
        g_S = objfunc.gradient_estimation(delImgAT_M_Sm1, delImgAT_M_Sm1, MGR.parSet['mu'], MGR.parSet['qx'], MGR.parSet['qy'], flag, randBatchBdx)
        ...
        for k in range(0, MGR.parSet['M']):
            ...
            #print('k',k, '\n')
            v_k_S  = objfunc.gradient_estimation(delImgAT_k_S, delImgAT_0_S, MGR.parSet['mu'], MGR.parSet['qx'], MGR.parSet['qy'], flag, randBatchIdx)
            #v_k_S -= objfunc.gradient_estimation(delImgAT_0_S, delImgAT_0_S, MGR.parSet['mu'], MGR.parSet['qx'], MGR.parSet['qy'], flag, randBatchIdx)
            v_k_S += g_S
