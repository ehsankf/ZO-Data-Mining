...
if __name__ == "__main__":
    ...
    parser.add_argument('-q', type=int, default=10, help="Number of random vectors to average over for each gradient estimation")
    ...
    parser.add_argument('-nStage', type=int, default=2000, help="Number of stages/epochs")
    ...
    parser.add_argument('-rv_dist', default='UnitBall', help="Choose from UnitSphere and UnitBall")
