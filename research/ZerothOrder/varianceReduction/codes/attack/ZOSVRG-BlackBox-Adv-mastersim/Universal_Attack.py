...
if __name__ == "__main__":
    ...
    #parser.add_argument('-qx', type=int, default=1, help="Number of random vectors to average over for each gradient estimation")
    #parser.add_argument('-qy', type=int, default= 1, help="Number of random vectors to average over for each gradient estimation")
    ...
    parser.add_argument('-nStage', type=int, default=3500, help="Number of stages/epochs")
    parser.add_argument('-const', type=float, default=5, help="Weight put on the attack loss")
    parser.add_argument('-lambda2', type=float, default=1, help="Coefficeint on L2 regularizer")
    parser.add_argument('-lambda1', type=float, default=1e-3, help="Coefficeint on L1 regularizer")
