...
def main():
    ...
    MGR.Add_Parameter('eta', MGR.parSet['alpha']) #MGR.parSet['alpha']/np.sqrt(origImgs[0].size)
    MGR.Log_MetaData()
...
if __name__ == "__main__":
    ...
    #parser.add_argument('-alpha', type=float, default= 0.25, help="Optimizer's step size being (alpha)/(input image size)")
    #parser.add_argument('-alpha', type=float, default= 0.15, help="Optimizer's step size being (alpha)/(input image size)")
    parser.add_argument('-alpha', type=float, default= 0.05, help="Optimizer's step size being (alpha)/(input image size)")
    ...
    parser.add_argument('-B_size', type=float, default=0.5, help="Fraction number of functions sampled for each iteration in the optmization steps")
