...
if __name__ == "__main__":
    ...
    parser.add_argument('-alpha', type=float, default= 0.104, help="Optimizer's step size being (alpha)/(input image size)")
    parser.add_argument('-M', type=int, default=30, help="Length of each stage/epoch")
