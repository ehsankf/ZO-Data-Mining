	...
	long n, long d, double lambda, double lambda1, long k)
{
	...
	for (long i = 0; i < d; i++) {
		...
		double obj2 = compute_function_value(w2, Xt, y, n, d, lambda, lambda1);
		double obj1 = compute_function_value(w1, Xt, y, n, d, lambda, lambda1);
...
void compute_zeroth_partial_gradient(double *Xt, double *w, double *y, double *g,
	...
	long n, long d, double lambda, double lambda1, long i, long k)

{
	...
	for (long j = 0; j < d; j++) {
		...
		double obj2 = compute_partial_function_value(w2, Xt, y, n, d, lambda, i);
		double obj1 = compute_partial_function_value(w1, Xt, y, n, d, lambda, i);
