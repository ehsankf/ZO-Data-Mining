...
all_pathes = ['mnist', 'ZOSVRG1', 'ZOPSVRG', 'ZOPSPIDER', 'ZOPSVRGRSGE1', 'ZOSAGA1', 'ZOSGD3']
...
for row in range(nrows):
    ...
    for col in range(ncols):
        ...
        if all_adv_examples[col].startswith('Adv_id57_'):
            pdb.set_trace()
...
# plt.show()
plt.pause(1.5)
plt.savefig("{}.png".format("mnist"), bbox_inches='tight', dpi=300)
plt.close()
